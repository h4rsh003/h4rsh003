      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 relative z-10">
          ...
          <a
            ...
            className="group relative p-6 md:p-8 rounded-4xl md:rounded-[2.5rem] bg-[#0A0A0A] border border-white/10 hover:border-blue-500/50 transition-all duration-300 overflow-hidden"
          >
          ...
          {/* 2. WhatsApp Card */}
          <a
            href={RESUME_DATA.contact.whatsapp}
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Chat with me on WhatsApp"
            className="group relative p-6 md:p-8 rounded-4xl md:rounded-[2.5rem] bg-[#0A0A0A] border border-white/10 hover:border-green-500/50 transition-all duration-300 overflow-hidden"
          >
          ...
          <a
            ...
            className="group relative p-6 md:p-8 rounded-4xl md:rounded-[2.5rem] bg-[#0A0A0A] border border-white/10 hover:border-blue-400/50 transition-all duration-300 overflow-hidden"
          >
          ...
          <a
            ...
            className="group relative p-6 md:p-8 rounded-4xl md:rounded-[2.5rem] bg-[#0A0A0A] border border-white/10 hover:border-gray-500/50 transition-all duration-300 overflow-hidden"
          >
